declare module "react-redux" {
  ...
  interface Connect<State, Action, Dispatch> {
    <P, StateProps, DispatchProps>(/**
                                    ...
                                    * Its result must be a plain object, and it will be merged into the component’s
                                    * props. If you omit it, the component will not be subscribed to the Redux store.
                                    * If ownProps is specified as a second argument, then mapStateToProps will be
                                    ...
                                    * to return an object that somehow uses dispatch to bind action creators in your
                                    * own way.
                                    ...
                                    * then mapDispatchToProps will be re-invoked whenever the component receives new
                                    * props.
                                    */
                                    ...
                                    * and the parent props. The plain object you return from it will be passed as props
                                    * to the wrapped component. You may specify this function to select a slice of the
                                    * state based on props, or to bind action creators to a particular variable from
                                    * props. If you omit it, Object.assign({}, ownProps, stateProps, dispatchProps) is
                                    * used by default.
                                    */
