declare module "redux" {
  ...
  interface StoreCreator<S, A> {
    (reducer: Reducer<S, A>, initialState?: S, enhancer?: Function): Store<S, A>;
  }

  export function createStore<S, A>(reducer: Reducer<S, A>, initialState?: S, enhancer?: Function): Store<S, A>;
  ...
  export function combineReducers<S, A>(reducers: Reducers): Reducer<S, A>
