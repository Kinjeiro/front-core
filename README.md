...
удобно получаете новые обновления и новый версии коры.

Вы не тратите уйму времени и деньги на настройку и подгонку плагинов, какие-то важные куски функциональности, 
которые уже дожны быть в любом enterprise проекте  
