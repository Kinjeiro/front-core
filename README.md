...
### Общие
- минимизация расходов на развертывание, генераторы - шаблоны для быстрого старта
- готовая база компонентов и логики
- низкий порог входа (junior в проекте могут сразу писать компоненты, не задумываюсь как это работает)
- надежная эксплуатация, стабильность обеспечена за счет того, что происходят фиксы со всех проектов 
...
- единая регистрируемая база компонентов с возможностью оборачивания, подмены и подгрузки при необходимости
