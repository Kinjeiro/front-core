...
[generator-front-core](https://github.com/Kinjeiro/generator-front-core)
...
- SSR, серверный рендеринг (минимальное время загрузки первой страницы)
